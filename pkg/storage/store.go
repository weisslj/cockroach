...
import (
	...
	"github.com/weisslj/cockroach/pkg/util/limit"
	...
	"github.com/weisslj/cockroach/pkg/util/shuffle"
...
func (s *Store) SetDraining(drain bool) {
	...
	if err := contextutil.RunWithTimeout(ctx, "wait for raft leadership transfer", raftLeadershipTransferWait,
		func(ctx context.Context) error {
			...
			// Avoid retry.ForDuration because of https://github.com/weisslj/cockroach/issues/25091.
...
func (s *Store) processRequestQueue(ctx context.Context, rangeID roachpb.RangeID) {
	...
	if hadError {
		...
		// forgiving.
		//
		// See https://github.com/weisslj/cockroach/issues/30951#issuecomment-428010411.
